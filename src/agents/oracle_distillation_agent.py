...
class OracleDistillationAgent:
    ...
    def call_oracle_solver(self, solver_cmd="minisat"):
        ...
        # Call the SAT solver
        try:
            subprocess.run([solver_cmd, cnf_filename, out_filename], 
    ...
    def _generate_trajectories(self, solution, n_trajectories=10, steps_per_trajectory=20):
    ...
    def collect_oracle_data(self, n_solutions=5, n_trajectories=10):
        ...
        for _ in range(n_solutions):
            ...
            if solution is not None:
                ...
                print(f"Oracle solution found with {sat_count}/{len(self.clauses)} satisfied clauses")
            else:
                print("Oracle failed to find a solution")
        
        print(f"Collected {len(self.oracle_solutions)} oracle solutions and "
    ...
    def iterative_refinement(self, max_iterations=100):
        ...
        for i in range(max_iterations):
            ...
            if candidate_satisfied > current_satisfied:
                ...
                print(f"Iteration {i}: Improved to {current_satisfied}/{len(self.clauses)} satisfied clauses")
