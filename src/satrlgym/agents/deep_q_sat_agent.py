...
from satrlgym_logger import SATRLLogger, wrap_agent_step
...
class DeepQLearningAgent:
    ...
    def report_progress(self, episode, total_reward, avg_reward):
        ...
        print(
            f"Episode: {episode}, Total Reward: {total_reward}, Avg Reward: {avg_reward}, Epsilon: {self.epsilon:.4f}"
        )
...
class DeepQSATAgent:
    ...
    def __init__(
        ...
        if enable_logging:
            self.logger = SATRLLogger(logs_dir or "satrlgym_logs/dqn")
