...
class UnsatisfiableError(SATBaseException):
    ...
    def __init__(
        self,
        message: str = "Problem is unsatisfiable",
...
class SolverTimeoutError(SATBaseException):
    ...
    def __init__(
        self,
        message: str = "Solver exceeded time limit",
        time_spent: float = None,
        partial_assignment: list[int] = None,
...
class InconsistentAssignmentError(SATBaseException):
    ...
    def __init__(
        self,
        message: str = "Inconsistent variable assignment detected",
        variable: int = None,
    ):
        """
        Initialize the exception.
...
class InvalidClauseError(SATBaseException):
    ...
    def __init__(
        self, message: str = "Invalid clause detected", clause: list[int] = None
    ):
        """
        Initialize the exception.
